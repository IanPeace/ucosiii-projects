...
typedef  struct bsp_i2c_dev_status {
    ...
    CPU_INT08U   OffsetLen;                                     /* Offset address length                                */
    CPU_INT08U  *OffsetPtr;                                     /* Pointer to the offset address area                   */
...
{   
    ...
    p_i2c_dev_status->OffsetPtr  = offset_buf;                  /* Set the offset buffer information                    */
    p_i2c_dev_status->OffsetLen  = offset_len;  
                 ...
                 switch (p_i2c_dev_status->AccessType) {
                     ...
                     case BSP_I2C_ACCESS_TYPE_WR_RD:
                          if (DEF_BIT_IS_SET(int_stat1, BSP_I2C_REG_SR1_TXE)) {                     
                              if (p_i2c_dev_status->OffsetLen != 0) {
                                  p_i2c_reg->I2C_DR = (CPU_INT32U)(*(p_i2c_dev_status->OffsetPtr));
                                  p_i2c_dev_status->OffsetPtr++;
                                  p_i2c_dev_status->OffsetLen--;
                              } else {
