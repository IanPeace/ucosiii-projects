...
; Vector Table Mapped to Address 0 at Reset
                IMPORT  BSP_IntHandlerRSVD0
                IMPORT  BSP_IntHandlerRSVD1
                IMPORT  BSP_IntHandlerRSVD2
                IMPORT  BSP_IntHandlerRSVD3
                IMPORT  BSP_IntHandlerRSVD4
                IMPORT  BSP_IntHandlerFTMRH
                IMPORT  BSP_IntHandlerLVD_LVW
                IMPORT  BSP_IntHandlerEXI
                IMPORT  BSP_IntHandlerI2C0
                IMPORT  BSP_IntHandlerRSVD9
                ...
                IMPORT  BSP_IntHandlerFTM0
                IMPORT  BSP_IntHandlerFTM1
                IMPORT  BSP_IntHandlerFTM2
                IMPORT  BSP_IntHandlerRTC
                IMPORT  BSP_IntHandlerACMP1
                IMPORT  BSP_IntHandlerPIT0
                IMPORT  BSP_IntHandlerPIT1
                IMPORT  BSP_IntHandlerKBI0
                IMPORT  BSP_IntHandlerKBI1
                IMPORT  BSP_IntHandlerRSVD26
                IMPORT  BSP_IntHandlerICS
                IMPORT  BSP_IntHandlerWDOG
                IMPORT  BSP_IntHandlerRSVD29
                IMPORT  BSP_IntHandlerRSVD30
                IMPORT  BSP_IntHandlerRSVD31
...
__Vectors       DCD     __initial_sp                            ; 000 Initial stack pointer.
                ...
                ; External Interrupts
                DCD     BSP_IntHandlerRSVD0
                DCD     BSP_IntHandlerRSVD1
                DCD     BSP_IntHandlerRSVD2
                DCD     BSP_IntHandlerRSVD3
                DCD     BSP_IntHandlerRSVD4
                DCD     BSP_IntHandlerFTMRH                     ; 021 IRQ[  5] Flash.
                DCD     BSP_IntHandlerLVD_LVW                   ; 022 IRQ[  6] Low Voltage Detect, Low Voltage Warning
                DCD     BSP_IntHandlerEXI                       ; 023 IRQ[  7] External Interrupt
                DCD     BSP_IntHandlerI2C0                      ; 024 IRQ[  8] I2C0 interrupt
                DCD     BSP_IntHandlerRSVD9
                ...
                DCD     BSP_IntHandlerACMP0                     ; 032 IRQ[ 16] ACMP0 interrupt
                DCD     BSP_IntHandlerFTM0                      ; 033 IRQ[ 17] FTM0 fault, overflow & channels intr
                DCD     BSP_IntHandlerFTM1                      ; 034 IRQ[ 18] FTM1 fault, overflow & channels intr
                DCD     BSP_IntHandlerFTM2                      ; 035 IRQ[ 19] FTM2 fault, overflow & channels intr
                DCD     BSP_IntHandlerRTC                       ; 036 IRQ[ 20] RTC overflow interrupt
                DCD     BSP_IntHandlerACMP1                     ; 037 IRQ[ 21] ACMP1 interrupt
                DCD     BSP_IntHandlerPIT0                      ; 038 IRQ[ 22] PIT timer channel 0 interrupt
                DCD     BSP_IntHandlerPIT1                      ; 039 IRQ[ 23] PIT timer channel 1 interrupt
                DCD     BSP_IntHandlerKBI0                      ; 040 IRQ[ 24] Keyboard interrupt 0
                DCD     BSP_IntHandlerKBI1                      ; 041 IRQ[ 25] Keyboard interrupt 1
                DCD     BSP_IntHandlerRSVD26
                DCD     BSP_IntHandlerICS                       ; 043 IRQ[ 27] MCG Interrupt
                DCD     BSP_IntHandlerWDOG                      ; 044 IRQ[ 28] WDOG interrupt
                DCD     BSP_IntHandlerRSVD29
                DCD     BSP_IntHandlerRSVD30
                DCD     BSP_IntHandlerRSVD31
__Vectors_End
...
App_Reset_ISR   PROC
                ...
                IMPORT  __main
                IMPORT  BSP_WDOG_Disable

                LDR     R0, =BSP_WDOG_Disable
                BLX     R0                                      ; Disable the watchdog timer.
