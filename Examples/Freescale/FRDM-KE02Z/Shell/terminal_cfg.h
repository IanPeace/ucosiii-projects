...
#define  TERMINAL_OS_CFG_TASK_PRIO                         3u
...
#define  TERMINAL_OS_CFG_TASK_STK_SIZE                   192u
...
#define  TERMINAL_CFG_MAX_CMD_LEN                         79u   /* Cfg max cmd  len         (see Note #1).              */
#define  TERMINAL_CFG_MAX_PATH_LEN                         7u   /* Cfg max path len         (see Note #2).              */

#define  TERMINAL_CFG_HISTORY_EN                 DEF_DISABLED   /* En/dis history           (see Note #3).              */
#define  TERMINAL_CFG_HISTORY_ITEMS_NBR                    4u   /* Cfg nbr history items    (see Note #4).              */
#define  TERMINAL_CFG_HISTORY_ITEM_LEN                    32u   /* Cfg history item len     (see Note #5).              */
