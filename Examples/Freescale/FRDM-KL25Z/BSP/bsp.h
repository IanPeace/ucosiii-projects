...
#define  BSP_INT_ID_TSI                                  26u    /* Single interrupt vector for all sources              */
#define  BSP_INT_ID_MCG                                  27u    /* MCG Interrupt                                        */
#define  BSP_INT_ID_LPTIMER                              28u    /* LPTimer interrupt                                    */
#define  BSP_INT_ID_RSVD29                               29u
#define  BSP_INT_ID_PORTA                                30u    /* Port A interrupt                                     */
#define  BSP_INT_ID_PORTD                                31u    /* Port D interrupt                                     */
